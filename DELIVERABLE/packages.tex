...
% IMAGES
\usepackage{graphicx} % Required for including and manipulating images in the document, such as resizing and rotating.
\usepackage{graphics} % Provides basic commands for including graphics. Note that graphicx is a more powerful and commonly used alternative.
...
\usepackage{fancyhdr} % Allows customization of header and footer styles in the document.
