...
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA, QUA CI MANCA TESTO DESCRITTIVO SULLE MODALITÀ ASSOCIATE ALLE FREQUENZE QUASI-PERIODICHE, CHE SONO QUELLE PIÙ INTERESSANTI DA UN PUNTO DI VISTA FISICO. IN PARTICOLARE, SI PUÒ NOTARE CHE LE MODALITÀ ASSOCIATI A QUESTE FREQUENZE MOSTRANO STRUTTURE SPAZIALI CHE NON SONO PRESENTI NELLE MODALITÀ ASSOCIATI ALLE FREQUENZE ARMONICHE, SUGGERENDO CHE QUESTE FREQUENZE QUASI-PERIODICHE POTREBBERO ESSERE LEGATE A DYNAMICS DIVERSI DA QUELLI DELLA INSTABILITÀ PRINCIPALE DELLA SHEAR LAYER.
\FloatBarrier
\begin{figure}[h!]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
...
The coherent structures corresponding to the main physical frequencies identified provide further information about the dynamics of the phoenomenon. At 1200~K, the modes with highest amplitude are spatially extended structures concentrated in the far field of the domain as shown in the Figure~\ref{fig:modes_1200K}, reflecting the downstream convection and roll-up of large-scale vortices that have had space and time to develop along the mixing layer. At 1700~K the dominant spatial activity is shifted towards the near field, immediately downstream of the splitter plate. This can be explained by the fact that the stronger heat release ties the energetically significant dynamics to the flame attachment as shown in Figure~\ref{fig:modes_1700K} with less coherent large-scale activity further downstream.
The transient case, i.e. 1500~K has energetically significant DMD modes in both the far field and the near field regions as shown in the DMD modes associated to the frequencies \ref{fig:modes_1500K} and the DMD MODES \ref{fig:comb_modes_1500K}. In this regime the instabilities are affected by both the far field convective instability and the energy release near the inlet.
\begin{comment}
