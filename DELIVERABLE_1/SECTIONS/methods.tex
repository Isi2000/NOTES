...
\subsection{HOSVD+GPR reduced order model for parametric interpolation}
...
\subsubsection*{Interpolation via GPR}
...
\begin{figure}[htbp]
    \centering
    % \includegraphics[width=0.80\textwidth]{../IMAGES/METHODS/hosvd_pipeline.png}
    \caption{[FIGURE: schematic of the HOSVD+GPR pipeline. Add when available.]}
